...
() {
  ...
  molokai_bg="#1b1d1e"
  molokai_fg="#f8f8f2"
  molokai_fg_gutter="#808080"
  molokai_comment="#7e8e91"
  molokai_blue="#819aff"
  molokai_cyan="#66d9ef"
  molokai_magenta="#f92672"
  molokai_purple="#ae81ff"
  molokai_orange="#fd971f"
  molokai_yellow="#e6db74"
  molokai_green="#a6e22e"
  molokai_springgreen="#00ff87"
  molokai_red="#ff4a44"
  molokai_error="#ff4a44"
  molokai_warning="#cd9731"
  molokai_info="#6796e6"
  molokai_hint="#b267e6"
